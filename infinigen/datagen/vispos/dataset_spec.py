...
class VisPosDatasetSpec:
    ...
    dataset_mode: str = "diversity"  # "diversity" or "invariance" or "hybrid"

DATASET_PRESETS = {
    "diversity_5k_eo": VisPosDatasetSpec(name="diversity_5k_eo", num_scenes=5000, scene_types=["nature_forest", "nature_desert", "urban_suburban"], seasons=["summer"], times_of_day=["noon"], platforms=["isr_orbit"], modalities=["eo"], dataset_mode="diversity"),
    "invariance_100_winter": VisPosDatasetSpec(name="invariance_100_winter", num_scenes=100, scene_types=["urban_dense_city"], seasons=["spring", "summer", "autumn", "winter"], times_of_day=["dawn", "morning", "noon", "afternoon", "dusk"], platforms=["isr_orbit", "fpv_scout"], modalities=["eo", "lwir"], paired_damage=True, dataset_mode="invariance"),
    "hybrid_ref": VisPosDatasetSpec(name="hybrid_ref", num_scenes=5100, scene_types=["nature_forest", "nature_desert", "urban_dense_city", "urban_suburban"], dataset_mode="hybrid"),
}
